                                    ...
                                    <div class="product product-widget-style">
                                        <div class="thumbnnail">
                                            <a href="{{route('product.detail',$pro->slug)}}"
                                                title="{{$pro->name}}">
                                                <figure><img src="{{asset('assets/images/products/'. $pro->image)}}" alt="{{$pro->name}}"></figure>
                                            </a>
                                        </div>
                                        <div class="product-info">
                                            <a href="{{route('product.detail',$pro->slug)}}" class="product-name"><span>{{$pro->name}}</span></a>
                                            <div class="wrap-price"><span class="product-price">{{$pro->reqular_price}}</span></div>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
                ...
                <div class="wrap-show-advance-info-box style-1 box-in-site">
                    ...
                    <div class="wrap-products">
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                            ...
                            @foreach ($related_prodcuts as $related_product)
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{route('product.detail',$related_product->slug)}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                        <figure><img src="{{asset('assets/images/products/' . $related_product->image)}}" width="214"
                                ...
                                <div class="product-info">
                                    <a href="{{route('product.detail',$related_product->slug)}}" class="product-name"><span>{{$related_product->name}}</span></a>
